...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    ...
    /// </summary>
    [TestModule("54ca3c52-3f05-47cb-897a-dbf733a51f74", ModuleType.Recording, 1)]
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Application", "Closing application containing item 'TestCaseStudy'.", repo.TestCaseStudy.SelfInfo, new RecordItemIndex(0));
            Host.Current.CloseApplication(repo.TestCaseStudy.Self, new Duration(0));
